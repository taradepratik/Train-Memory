...
import com.example.andro.models.MemoryCard
...
class MemoryBoardAdapter(private val context: Context,
    ...
    override fun onCreateViewHolder(parent: ViewGroup, viewType: Int): ViewHolder {
        ...
        //layout params allow us to change width and height
    ...
    inner class ViewHolder(itemView: View) : RecyclerView.ViewHolder(itemView) {
        ...
        private val  imageButton = itemView.imageButton

        fun bind(position: Int) {
            val memoryCard = cards[position]
            if(memoryCard.isFaseUp){
                ...
                imageButton.setImageResource(R.drawable.face_down)
            }
